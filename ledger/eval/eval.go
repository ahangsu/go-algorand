...
// ReachingMaxTxnBytesPerBlock checks whether current number of bytes tracked
// by BlockEvaluator is reaching MaxTxnBytesPerBlock, which is the maximum
// number of bytes that transactions can take up in a block.
func (eval *BlockEvaluator) ReachingMaxTxnBytesPerBlock() bool {
